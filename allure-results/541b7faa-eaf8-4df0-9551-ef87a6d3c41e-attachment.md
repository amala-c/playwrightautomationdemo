...
- Name: userSignUp.spec.js >> close signup details
- Location: tests/userSignUp.spec.js:24:6
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox "Username:" [active] [ref=e12]: testamala
          - generic [ref=e13]:
...
```ts
  ...
  2  |     constructor(page){
  3  |         this.page=page
  4  |         this.signupLink=page.locator('#signin2')
  5  |         this.username=page.locator('#sign-username')
  6  |         this.password=page.locator('#sign-password')
  7  |         this.signupbtn=page.getByRole('button', { name: 'Sign up' })
  8  |         this.closebtn=page.locator("//button[@class='btn btn-secondary']").nth(1)
  9  |     }
  10 |     async clickHyperlink()
  11 |     {
  12 |         await this.signupLink.click();
  13 |         await this.username.waitFor({ state: 'visible' });
  14 |     }
  15 |     async SignUpCredentials(username,password){
...
> 17 |         await this.password.fill(password)
  ...
  20 |    async signUpFlow()
  21 |     {
  22 |         await this.signupbtn.click()
  23 |     }
  24 |     async closeFlow()
  25 |     {
  26 |         await this.closebtn.click()
  27 |     }
  28 | }
```